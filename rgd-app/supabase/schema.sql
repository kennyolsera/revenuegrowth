...
-- =====================================================================
-- 1. Undang diri Anda sendiri sebagai user pertama lewat Supabase
--    Dashboard > Authentication > Users > Invite user (atau lewat menu
--    User Management di aplikasi setelah SUPABASE_SERVICE_ROLE_KEY diset).
-- 2. Jadikan user pertama tersebut sebagai Super Admin dengan query:
--      update public.profiles set role = 'super_admin' where email = 'email-anda@perusahaan.com';
-- 3. Selesai — login ke aplikasi dengan akun tersebut.
